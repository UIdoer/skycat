...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="${sourcePath}/js/baby_ban.js">
   <script type="text/javascript">
...
<div class="i_bg">
	...
	<div>
	<form action="${basePath}/goodComment/doGoodComment"  enctype="multipart/form-data" method="post" >
	 <h1>商品评价页</h1><br /><br />
	 <h5>评价等级：</h5>
	 好评：<input name="comGrade" value="0" type="radio"/>&nbsp;&nbsp; 中评：<input  name="comGrade" value="1" type="radio"/>&nbsp;&nbsp; 差评：<input type="radio"  name="comGrade" value="2"/>&nbsp;&nbsp;
	 <h5>评价内容：</h5>
	 <textarea id="comText"  name="comText" rows="10" cols="100"></textarea><br />
	
	 评价晒图：<input  name="files"  type="file"/><input  name="files"  type="file"/><input  name="files"  type="file"/><input  name="files"  type="file"/><br /><br />
	 <input type="hidden" name="goodId" value="${goodId}"/><span style="color: red;">${msg}</span><br />
	 <input type="submit" />
	</form>	
	</div>
